        ...
        <div class="icons">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="owner_das.php">Profile</a></li>
    ...
    <nav class="container-lg mt-4">
        <div class="home-page">
            <div class="main-content">
                ...
                <a href="add_hotel.html" class="btn">Register Hotel</a>
            </div>
            <div class="home-img">
        ...
        <div class="card-container">
            ...
            SELECT 
                    ...
                    FROM hotels h
                    INNER JOIN discounts d ON h.hotel_id = d.hotel_id  -- Ensures only hotels with discounts are included
                    LEFT JOIN rooms r ON h.hotel_id = r.hotel_id
                    WHERE d.discount_percentage IS NOT NULL  -- Filters out any NULL discounts (just in case)
                    ...
                    LIMIT 6"; // Fetch only the first 6 hotels with discounts
        ...
        <div class="card2-container">
            ...
            LIMIT 8"; // Get the top 8 most liked hotels
